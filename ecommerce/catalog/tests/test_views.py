...
class ProductTest(test_setup.ProductTestSetup):
    ...
    def test_creation(self):
        res = self.client.post(self.url, self.json_post_data)
        print('POST\n{}\n'.format(res.data))
    ...
    def test_update(self):
        ...
        res = self.client.patch(self.url, self.json_patch_data, format='json')
        print('PATCH\n{}\n'.format(res.data))
...
class VariantTest(test_setup.VariantTestSetup):
    ...
    def test_update(self):
        ...
        for v in variants:
            ...
            res = self.client.patch(url, self.json_patch_data, format='json')
...
class CategoryTest(test_setup.CategoryTestSetUp):
    ...
    def test_category(self):
        ...
        res = self.client.patch(url_category, patch_data, format='json')
